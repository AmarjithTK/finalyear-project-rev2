...
def generate_local_report(df_forecast):
    ...
    solar = series_from(df_forecast, "Solar_Predicted_MW", "Solar_MW")
    wind = series_from(df_forecast, "Wind_Predicted_MW", "Wind_MW")
...
- Average solar at bus 675: **{solar.mean():.4f} MW**
- Average wind at bus 680: **{wind.mean():.4f} MW**
...
- Average Solar Gen at Bus 675: {solar.mean():.2f} MW
- Average Wind Gen at Bus 680: {wind.mean():.2f} MW
- Average Grid Import: {grid_import.mean():.4f} MW
